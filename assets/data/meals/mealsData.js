...
export const MEALS_DATA = {
    ...
    15: { ...MEALS_DATA[4] }, // Mediterranean Losos + Keto English Breakfast
    16: { ...MEALS_DATA[8] }, // Steak & Eggs + Meatballs u Krem Umaku
    17: { ...MEALS_DATA[9] }, // Škampi Skrambl + Coconut Curry Škampi
    18: { ...MEALS_DATA[10] }, // Caprese Bowl + Zapečena Piletina sa Sirom
    19: { ...MEALS_DATA[11] }, // Carbonara Eggs + Asian Losos Bowl
    20: { ...MEALS_DATA[4] }, // Mediterranean Losos + Keto English Breakfast
    21: { ...MEALS_DATA[5] }, // Mediterranean Omlet + Biftek sa Pesto Povrćem
    22: { ...MEALS_DATA[6] }, // Avokado Toast + Punjena Piletina
    23: { ...MEALS_DATA[7] }, // Skandinavski Losos + Tuna Nicoise Salad
    24: { ...MEALS_DATA[8] }, // Steak & Eggs + Meatballs u Krem Umaku
    25: { ...MEALS_DATA[9] }, // Škampi Skrambl + Coconut Curry Škampi
    26: { ...MEALS_DATA[10] }, // Caprese Bowl + Zapečena Piletina sa Sirom
    27: { ...MEALS_DATA[11] }, // Carbonara Eggs + Asian Losos Bowl
    28: { ...MEALS_DATA[1] }  // Originalni dan 1 - zatvaranje ciklusa
};
