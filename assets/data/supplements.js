...
const detaljiSuplemenata = {
    ...
    "Flex Pro+": {
        brend: "Muscle Freak",
        napomene: "⭐ Prioritet #3 - kompleksna podrška za zglobove. Sadrži kurkumin, glukozamin i hondroitin. Uzimati uz obrok."
    },
    "Vitamin C": {
        brend: "Standardni",
    ...
    "ZMA": {
        brend: "Pro",
        napomene: "Cink + Magnezij + B6. Oporavak i hormonska podrška. 30-60 min prije spavanja na prazan stomak. Rotirati sa solo magnezij."
    },
    "Whey Protein": {
        brend: "Isolate",
        napomene: "Praktičan izvor proteina kad je potreban. 1 mjerica (~25g proteina). Najbolje nakon treninga ili između obroka."
    },
    "Ashwagandha": {
        brend: "Adaptogen",
        napomene: "300-600mg uveče. Smanjuje kortizol i poboljšava kvalitet sna. Opciono za period visokog stresa."
    },
    "MCT C8": {
        brend: "Caprylic Acid",
        napomene: "Započeti sa 1 kašičica → 1 supena kašika. Brza energija u ketozi. Ujutru ili prije aktivnosti. Može uzrokovati probavne smetnje."
